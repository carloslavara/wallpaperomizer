const presets = [
  {
    ...
    modes: {
      lockScreen: [
        ...
        { id: 'safe-content', label: 'Artwork safe area', x: 0, y: 1055, width: 1242, height: 1515, kind: 'informational' },
        { id: 'safe-content-conservative', label: 'Safe area (conservative)', x: 0, y: 1080, width: 1242, height: 1470, kind: 'informational' },
