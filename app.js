const presets = [
  {
    ...
    modes: {
      lockScreen: [
        { id: 'status-date', label: 'Date / weather', x: 95, y: 230, width: 1052, height: 90, kind: 'danger' },
        { id: 'clock', label: 'Clock container', x: 95, y: 350, width: 1052, height: 395, kind: 'danger' },
        { id: 'widgets', label: 'Widgets container', x: 95, y: 770, width: 1052, height: 285, kind: 'danger' },
        { id: 'safe-content', label: 'Artwork safe area', x: 95, y: 1055, width: 1052, height: 1515, kind: 'informational' },
        { id: 'safe-content-conservative', label: 'Safe area (conservative)', x: 95, y: 1080, width: 1052, height: 1470, kind: 'informational' },
