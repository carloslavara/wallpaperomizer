const presets = [
  {
    ...
    modes: {
      lockScreen: [
        { id: 'notch', label: 'Notch', x: 370, y: 35, width: 500, height: 135, kind: 'cutout' },
        { id: 'clock', label: 'Clock area', x: 120, y: 175, width: 1000, height: 300, kind: 'danger' },
        { id: 'widgets', label: 'Widget area', x: 90, y: 520, width: 1060, height: 520, kind: 'danger' },
        { id: 'bottom', label: 'Bottom area', x: 0, y: 2510, width: 1242, height: 178, kind: 'danger' }
      ],
      homeScreen: [
